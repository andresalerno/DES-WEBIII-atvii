...
public class AutomanagerApplication {
	...
	public static class Runner implements ApplicationRunner {
		...
		public void run(ApplicationArguments args) throws Exception {
			...
			cliente.setDataCadastro(Calendar.getInstance().toInstant().atZone(java.time.ZoneId.systemDefault()).toLocalDate());
			cliente.setDataNascimento(calendario.getTime().toInstant().atZone(java.time.ZoneId.systemDefault()).toLocalDate());
